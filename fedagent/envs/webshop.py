...
in the verl-agent-webshop env behind ``fedagent.webshop_service`` (HTTP), because
WebShop's deps (torch 2.6 / gym 0.24 / pyserini / numpy 1.26) hard-conflict with verl 0.8.
